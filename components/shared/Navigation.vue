<template>
  <nav
    class="grid items-start gap-1 px-2 text-lg md:text-sm font-medium lg:px-4"
  >
    ...
    <NuxtLink
      ...
      :class="[
        'mx-[-0.65rem] max-h-min md:mx-0 flex items-center gap-4 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary hover:bg-muted',
